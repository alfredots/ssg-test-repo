...
var iconvLite = __webpack_require__(4713);
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __webpack_require__(3933)(stream_module);
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(8748) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
        encodeSkipVals: [{from: 0xED40, to: 0xF940}],
    },
    'csshiftjis': 'shiftjis',
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(7686) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2569) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(2569).concat)(__webpack_require__(1463)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(6264) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(8894) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__webpack_require__(8894).concat)(__webpack_require__(9738)) },
...
var bomHandling = __webpack_require__(6341),
    iconv = module.exports;
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(1881); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(5722)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(14)(iconv);
}
